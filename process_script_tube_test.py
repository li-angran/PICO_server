...
# %%
    ...
    "/mnt/nas00/lk/pico/Experiments/acc_test/angular-velocity-test/16_angular/16bright_calcium/frames",
"/mnt/nas00/lk/pico/Experiments/acc_test/angular-velocity-test/16_angular/16dark_calcium/frames"]
, help='Path to the data directory')
    
    parser.add_argument('--out_path', type=str, default='/mnt/nas00/lk/pico/Experiments/acc_test/angular-velocity-test/16_angular/Analysis', help='Path to the output directory')
