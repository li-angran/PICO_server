...
class Estimates(object):
    ...
    def plot_contours(self, img=None, idx=None, thr_method='max',
        ...
        if outpath is not None:
            plt.savefig(outpath + '\\countours.png')
        return self
    ...
    def view_components(self, Yr=None, img=None, idx=None, outpath=None):
        ...
        if outpath is not None: # modified by YZ
            plt.savefig(outpath + '\\components.png')
        return self
