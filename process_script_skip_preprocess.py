...
# %%
    ...
    # flow control
    parser.add_argument('--jump_to_rmbg', type=str2bool, default=True, help='this one assume you have done the MC and want to redo the rest')
    parser.add_argument('--jump_to_seg', type=str2bool, default=True, help='this one assume you have done the RMBG and want to redo the rest')
    ...
    parser.add_argument('--data_path', type=str, default="/mnt/nas00/lk/pico/Experiments/multimice/20250104multimice5/group1/80#/frames", help='Path to the data directory')
    parser.add_argument('--out_path', type=str, default="/mnt/nas00/lk/pico/Experiments/multimice/20250104multimice5/group1/80#/Analysis", help='Path to the output directory')
    ...
    parser.add_argument('--minArea', type=int, default=30, help='Minimum neuron area')
    ...
    parser.add_argument('--thresh_COM', type=int, default=6, help='Merge threshold')
...
def PICO_processing(args):
    ...
    if not jump_to_rmbg:
        ...
        frame_number = len(os.listdir(preprocess_out))
        ...
        for i in tqdm(range(frame_number)):
            ...
            img = cv2.imread(os.path.join(preprocess_out, f"frame_{i}.tif"), cv2.IMREAD_GRAYSCALE).astype(np.float16)

            video_preprocessed.append(img)
